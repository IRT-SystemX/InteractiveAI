...
def test_get_all_rte_events(client, rte_auth_mocker, create_events):
    headers = {
...
def test_get_events_for_use_case(client, rte_auth_mocker, create_events):
    headers = {
        'Authorization': f'Bearer {RTE_BEARER_TOKEN}'
    }
...
def test_add_rte_event(client, rte_auth_mocker, mock_of_create_cards_request):
    event_data = {
        "criticality": "ROUTINE",
...
def test_update_rte_event_if_exist(client, rte_auth_mocker, mock_of_create_cards_request):
...
def test_add_da_event(client, da_auth_mocker, mock_of_create_cards_request):
    event_data = {
        "criticality": "HIGH",
...
def test_add_sncf_event(client, sncf_auth_mocker, mock_of_create_cards_request):
    event_data = {
...
def test_update_sncf_event_if_exist(client, sncf_auth_mocker, mock_of_create_cards_request):
