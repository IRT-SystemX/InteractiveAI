...
def test_get_all_rte_contexts(client, create_contexts, rte_auth_mocker):
...
def test_add_rte_context(client, rte_auth_mocker):
    context_data = {
...
def test_add_da_context(client, da_auth_mocker):
    context_data = {
        "date": "2022-10-01T16:08:29.060050",
        "data": {
            "system": "AIR CONDITIONING AND PRESSURIZATION",
            "context_type": "90 PRESS: CABIN ALT TOO HI",
        },
        "use_case": "DA",
    }
...
def test_add_sncf_context(client, sncf_auth_mocker):
    context_data = {
        "date": "2022-12-01T16:08:29.060050",
        "data": {
            "trains": [
...
def test_add_orange_context(client, orange_auth_mocker):
    context_data = {
...
def test_get_with_use_case(
    client, create_contexts, publisher_test_auth_mocker
):
